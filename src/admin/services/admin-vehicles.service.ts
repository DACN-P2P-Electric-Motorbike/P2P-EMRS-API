    ...
    return {
      data: vehicles.map((v) => ({
        ...
        vehicle_info: {
          ...
          images: v.images,
          first_registration_year: v.firstRegistrationYear,
          condition: v.condition,
          battery_type: v.batteryType,
          battery_health: v.batteryHealth,
          battery_cycle_count: v.batteryCycleCount,
          battery_last_serviced_at: v.batteryLastServicedAt,
        },
        status: v.status,
      })),
      pagination: {
